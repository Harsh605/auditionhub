                    ...
                    <div className="col-lg-6 col-md-12">
                      <div className="form-group">
                        <input
                          ...
                          placeholder="अपनी ऊंचाई दर्ज करें (ex. 4 Feet 3 inch = 4.3)"
                          type="text"
                    ...
                    <div className="col-lg-6 col-md-12">
                      <div className="form-group">
                        <input
                          ...
                          placeholder="अपना वजन दर्ज करें"
                          type="text"
                          onBlur={() => trigger("width")}
                        />
                        {errors.width && <Error>{errors.width.message}</Error>}
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-12">
                      <div className="form-group">
                        <Controller
                          ...
                          rules={{ required: "Please select a complexion." }}
                        />
                      </div>
                    </div>
                  </div>
                          ...
                          render={({ field }) => (
                            <div>
                              <select
                                {...field}
                                className={`form-control ${
                                  errors.auditionCategory ? "is-invalid" : ""
                                }`}
                              >
                              ...
                              {errors.auditionCategory && (
                                <Error>{errors.auditionCategory.message}</Error>
                              )}
                            </div>
                          )}
                          rules={{
